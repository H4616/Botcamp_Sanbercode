<!--exstends untuk untuk memanggil kodingan masterLayout sebagai template   -->
@extends('Tugas13.MasterLayout')

<!--push untuk menambahkan kodingan dalam template   -->
@push("script")
